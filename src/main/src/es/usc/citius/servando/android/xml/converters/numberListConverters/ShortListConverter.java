 ...
 */
public class ShortListConverter implements Converter<ShortList> {
	...
	@Override
	public ShortList read(InputNode in) throws Exception
	{
		ShortList fl = new ShortList();
		// Leemos los valores
	...
	@Override
	public void write(OutputNode on, ShortList t) throws Exception
	{
